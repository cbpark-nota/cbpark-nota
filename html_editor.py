...
def edit_html(language:Literal["한국어", "English"], src_dir:Literal["docs/ko", "docs"]):
    for file_name in file_names:
        ...
        # ret = subprocess.PIPE("echo $PWD")
        with open('./docs/error_messages.html', 'r', encoding='utf-8') as file:
        ...
        with open(f'{src_dir}/{file_name}.html', 'w', encoding='utf-8') as file:
            file.write(str(soup))

edit_html(language="한국어", src_dir="/app/cbpark-nota/docs")
